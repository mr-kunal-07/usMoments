...
import { FolderGridWithSelection } from "@/components/FolderGridWithSelection";
...
const MemoriesTimeline = lazy(() =>
  import("@/components/MemoriesView").then((module) => ({ default: module.MemoriesTimeline }))
);
const AnniversariesView = lazy(() =>
  import("@/components/AnniversariesView").then((module) => ({ default: module.AnniversariesView }))
);
...
const RecentlyDeletedView = lazy(() =>
  import("@/components/RecentlyDeletedView").then((module) => ({ default: module.RecentlyDeletedView }))
);
const LoveStoryView = lazy(() =>
  import("@/components/LoveStoryView").then((module) => ({ default: module.LoveStoryView }))
);
